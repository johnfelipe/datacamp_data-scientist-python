...
plt.plot(x,y)
plt.show()
The world bank has estimates of the world population for the years 1950 up to 2100. The years are loaded in here as a list called year, and the corresponding populations as a list called pop.
...
To accomplish this, there is a list pop loaded here. It contains population numbers for each country expressed in millions. You can see that this list is added to the scatter method, as the argument s, for size.
